SavefileManager.SETTING_SLOT = 68
SavefileManager.PROGRESS_SLOT = SystemInfo:platform() == Idstring("WIN32") and 69
SavefileManager.BACKUP_SLOT = SystemInfo:platform() == Idstring("WIN32") and 69
