local infinite_downed_time = true
if ( infinite_downed_time == true ) then
	downed_timer = math.huge
else
	downed_timer = 60
end
	...
	function CharacterTweakData:_presets(tweak_data, ...)
		...
		local presets = _presets_orig(self, tweak_data, ...)
			...
			presets.gang_member_damage_1 = {
				...
				DOWNED_TIME = downed_timer,
				TASED_TIME = math.random(8, 12),
				BLEED_OUT_HEALTH_INIT = math.random(50, 75),
				ARRESTED_TIME = math.random(10, 40),
				INCAPACITATED_TIME = math.huge,
				hurt_severity = {
