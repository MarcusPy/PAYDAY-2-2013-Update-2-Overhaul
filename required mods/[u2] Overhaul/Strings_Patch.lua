...
Hooks:Add("LocalizationManagerPostInit", "CHANGE_Strings_Patch", function(loc)
    LocalizationManager:add_localized_strings({
		...
		menu_difficulty_hard = "SWAT RESPONSE",
		menu_risk_swat = "> SWAT RESPONSE",
		
		
		menu_difficulty_very_hard = "FBI RESPONSE",
		menu_risk_fbi = "> FBI RESPONSE",
		
	
		menu_difficulty_overkill = "CRACKDOWN",
		menu_risk_special = "> CRACKDOWN",
