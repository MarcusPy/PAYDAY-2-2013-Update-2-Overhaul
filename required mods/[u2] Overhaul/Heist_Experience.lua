...
if RequiredScript == "lib/managers/experiencemanager" then
	function ExperienceManager:get_xp_dissected( success, num_winners )
		...
		if managers.job:is_current_job_professional() then
			xp_multiplier = managers.experience:get_contract_difficulty_multiplier( total_difficulty_stars ) * 2 
		else
			xp_multiplier = managers.experience:get_contract_difficulty_multiplier( total_difficulty_stars ) * 1.75 -- 75% more difficulty based xp because progression is very sluggish
		end
