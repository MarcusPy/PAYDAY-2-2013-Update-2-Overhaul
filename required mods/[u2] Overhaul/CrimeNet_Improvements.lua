if RequiredScript == "lib/managers/crimenetmanager" then
    ...
    function CrimeNetGui:init( ws, fullscreeen_ws, node, ... )
		...
		if _G.u2_core.settings.crimenet_visuals.crimenet_background_color ~= 1 then
			map:set_color(_G.colors.solid[_G.u2_core.settings.crimenet_visuals.crimenet_background_color - 1])
		end
    end
