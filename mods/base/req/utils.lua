...
function Utils:IsCurrentWeapon(type)
	local weapon = managers.player:player_unit():inventory():equipped_unit():base()._name_id
	if weapon then
...
function Utils:IsCurrentWeaponPrimary()
	local weapon = managers.player:player_unit():inventory():equipped_unit():base():selection_index()
